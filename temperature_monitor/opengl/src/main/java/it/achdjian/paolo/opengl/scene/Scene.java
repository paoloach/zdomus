 ...
 */
package it.achdjian.paolo.opengl.scene;
...
import it.achdjian.paolo.opengl.cameras.Camera;
import it.achdjian.paolo.opengl.lights.ALight;
import it.achdjian.paolo.opengl.materials.Material;
import it.achdjian.paolo.opengl.materials.plugins.ShadowMapMaterialPlugin;
...
import it.achdjian.paolo.opengl.materials.textures.Texture;
import it.achdjian.paolo.opengl.math.Matrix4;
import it.achdjian.paolo.opengl.math.vector.Vector3;
import it.achdjian.paolo.opengl.postprocessing.materials.ShadowMapMaterial;
import it.achdjian.paolo.opengl.primitives.Cube;
import it.achdjian.paolo.opengl.render.AFrameTask;
import it.achdjian.paolo.opengl.render.RenderTarget;
import it.achdjian.paolo.opengl.render.Renderer;
import it.achdjian.paolo.opengl.render.plugins.IRendererPlugin;
import it.achdjian.paolo.opengl.render.plugins.Plugin;
import it.achdjian.paolo.opengl.scenegraph.IGraphNode;
import it.achdjian.paolo.opengl.scenegraph.IGraphNode.GRAPH_TYPE;
import it.achdjian.paolo.opengl.scenegraph.Octree;
import it.achdjian.paolo.opengl.util.ObjectColorPicker;
import it.achdjian.paolo.opengl.view.ISurface;

import static it.achdjian.paolo.opengl.util.ObjectColorPicker.pickObject;
