...
namespace zigbee {
    namespace http {
        namespace test {
            ...
            ZEndpoint ZDeviceFixture::endpoint1_1 = {NwkAddr {10}, EndpointID(11), 12, 13, 14, {ClusterID {1}, ClusterID {2}, ClusterID {3}},
                                                     {ClusterID {4}, ClusterID {5}, ClusterID {6}}};
            ZEndpoint ZDeviceFixture::endpoint2_1 = {NwkAddr {20}, EndpointID(21), 22, 23, 24, {ClusterID {7}, ClusterID {8}, ClusterID {9}},
                                                     {ClusterID {10}, ClusterID {11}, ClusterID {12}}};
