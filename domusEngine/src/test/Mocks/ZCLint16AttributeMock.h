/*
 * ZCLint16AttributeMock.h
 *
 *  Created on: 11/gen/2015
 *      Author: Paolo Achdjian
 */

#ifndef SRC_TEST_MOCKS_ZCLINT16ATTRIBUTEMOCK_H_
#define SRC_TEST_MOCKS_ZCLINT16ATTRIBUTEMOCK_H_
...
class ZCL_int16_AttributeMock : public ZCL_int16_Attribute {
public:
	ZCL_int16_AttributeMock();
	virtual ~ZCL_int16_AttributeMock();
...
#endif /* SRC_TEST_MOCKS_ZCLINT16ATTRIBUTEMOCK_H_ */
