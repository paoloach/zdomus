...
public:
	...
	MOCK_METHOD4(getCluster, std::shared_ptr<Cluster> (ClusterID clusterId,std::shared_ptr<ZigbeeDevice> & zigbeeDevice, EndpointID endpoint, NwkAddr networkAddress));
};
