...
namespace zigbee {
    namespace test {
        ...
        JavaScriptExecuterTest::~JavaScriptExecuterTest() {
        }
        ...
        void JavaScriptExecuterTest::SetUp() {
            ...
            EXPECT_CALL(singletonObjects, getFixedPathContainer()).Times(AnyNumber()).WillRepeatedly(
                    Return(fixedPathContainer));
        }
        ...
        TEST_F(JavaScriptExecuterTest, creating_attribute_ZCL_uint8) {
            ...
            js << objectName << "('" << EXTENDED_ADDRESS << "', " << ENDPOINT_ID << ", " << BASIC_CLUSTER << ","
        ...
        TEST_F(JavaScriptExecuterTest, creating_attribute_ZCL_uint8_log_type) {
            ...
            js << "var a = " << objectName << "('" << EXTENDED_ADDRESS << "', " << ENDPOINT_ID << ", " << BASIC_CLUSTER
               << "," << APPLICATION_VERSION_ID << ");";
            js << "var log = Log();";
            js << "log.info(a);";
        ...
        TEST_F(JavaScriptExecuterTest, creating_attribute_ZCL_uint8_log_type_two_time) {
            ...
            js << "var log = Log();";
            js << "if (a == null){";
            js << "  var a = " << objectName << "('" << EXTENDED_ADDRESS << "', " << ENDPOINT_ID << ", "
               << BASIC_CLUSTER << "," << APPLICATION_VERSION_ID << ");";
            js << "} else {";
            js << "  log.info(a);";
            js << "};";
        ...
        TEST_F(JavaScriptExecuterTest, creating_invalid_attribute_ZCL_uint16_and_then_valid) {
            ...
            jsException << objectName_16uint << "('" << EXTENDED_ADDRESS << "', " << ENDPOINT_ID << ", "
                        << BASIC_CLUSTER << "," << APPLICATION_VERSION_ID << ");";
            ...
            jsRight << objectName_8uint << "('" << EXTENDED_ADDRESS << "', " << ENDPOINT_ID << ", " << BASIC_CLUSTER
                    << "," << APPLICATION_VERSION_ID << ");";
