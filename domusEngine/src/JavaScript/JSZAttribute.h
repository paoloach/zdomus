...
namespace zigbee {
    ...
    public:
        JSZAttribute(SingletonObjects * singletonObjects, JSCallbackFifo & jsCallbackFifo,  ZCLTypeDataType zclType):
        singletonObjects(singletonObjects), callbackFifo(jsCallbackFifo), zclType(zclType){}
