...
JSZCluster::JSZCluster(const std::shared_ptr<ZDevices>& zDevices, const std::shared_ptr<ZigbeeDevice>& zigbeeDevice,
        const std::shared_ptr<JSZAttributeFactory> & jsZAttributeFactory_, const std::shared_ptr<ClusterTypeFactory> & clusterFactory) :
		zDevices(zDevices), zigbeeDevice(zigbeeDevice), clusterFactory(clusterFactory), jsZAttributeFactory(jsZAttributeFactory_) {
}
