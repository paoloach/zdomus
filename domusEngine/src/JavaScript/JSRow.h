...
namespace zigbee {
    ...
    class JSRow {
    public:
        virtual ~JSRow()= default;

    public:
        virtual void initJsObjectsTemplate(v8::Isolate *isolate, v8::Handle<v8::Object> &global);

        virtual v8::Local<v8::Object> createInstance(v8::Isolate *isolate, std::unique_ptr<DBRow> &&  dbRow);
    ...
    private:
        ...
        std::map<DBRow *, v8::Persistent<v8::Object, v8::CopyablePersistentTraits<v8::Object>>> createdObject;
