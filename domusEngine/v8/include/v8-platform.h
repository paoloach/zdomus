...
class Platform {
 public:
   ...
   */
  virtual void CallIdleOnForegroundThread(Isolate* , IdleTask* ) {
   ...
   */
  virtual bool IdleTasksEnabled(Isolate* ) {
    // TODO(ulan): Make this function abstract after V8 roll in Chromium.
    return false;
  }
   ...
   **/
  virtual const uint8_t* GetCategoryGroupEnabled(const char* ) {
    static uint8_t no = 0;
    return &no;
  }
  ...
  virtual uint64_t AddTraceEvent(
      char , const uint8_t* , const char* ,
      const char* , uint64_t , uint64_t , int32_t ,
   ...
   **/
  virtual void UpdateTraceEventDuration(const uint8_t* ,
                                        const char* , uint64_t ) {}
